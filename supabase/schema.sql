...
-- ═════════════════════════════════════════════════════════════
-- Study Companion (3rd mini-app) — active-recall cards + SM-2 spaced repetition.
-- (Also available standalone as migrations/004_study_companion.sql.)
-- ═════════════════════════════════════════════════════════════
...
-- ═════════════════════════════════════════════════════════════
-- Generic store for "analyze/generate + save + revisit" mini-apps
-- (Contract Explainer, Meeting-to-Action, Career Roadmap, Meal Planner, …).
-- (Also available standalone as migrations/005_app_items.sql.)
-- ═════════════════════════════════════════════════════════════
